...
export interface IFeedContent extends Document {
    id: string;
    title: string;
...
const FeedContentSchema: Schema = new Schema({
    id: { type: String},
    title: { type: String},
...
export default mongoose.model<IFeedContent>('FeedContent', FeedContentSchema);